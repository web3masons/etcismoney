...
export const rows = [
  ...
  { key: 'proofOfWork', name: 'Proof of Work', text: 'ETH has switched Proof of Stake. ETC is committed to remaining on the more secure Proof of Work indefinitely.' },
  ...
  { key: 'premine', name: 'No Premine', text: 'About 70m ETH was pre-allocated to investors and developers. ETC and BTC distributions were not pre-mined.' },
  { key: 'foundation', name: 'No CEO', text: 'BTC and ETC have no central leadership or foundation to direct development, making them more decentralized and resilient.' },
